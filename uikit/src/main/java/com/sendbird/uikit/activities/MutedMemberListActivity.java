...
public class MutedMemberListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(url)) {
            ...
            Fragment fragment = createMutedMemberListFragment(url);
    ...
    /**
     * It will be called when the MutedMemberListActivity is being created.
     *
    ...
    protected Fragment createMutedMemberListFragment(@NonNull String channelUrl) {
        return new MutedMemberListFragment.Builder(channelUrl)
                ...
                .setEmptyIcon(R.drawable.icon_mute, SendBirdUIKit.getDefaultThemeMode().getMonoTintColorStateList(this))
