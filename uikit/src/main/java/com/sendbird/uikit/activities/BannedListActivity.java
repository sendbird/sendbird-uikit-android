...
public class BannedListActivity extends AppCompatActivity {
    /**
     * Create an intent for a {@link BannedListActivity}.
     *
    ...
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl) {
        return newIntentFromCustomActivity(context, BannedListActivity.class, channelUrl);
    }

    /**
     * Create an intent for a custom activity.
     * The custom activity must inherit {@link BannedListActivity}.
     *
     * @param context A Context of the application package implementing this class.
     ...
     * @since 1.2.0
     */
    public static Intent newIntentFromCustomActivity(@NonNull Context context, @NonNull Class<? extends BannedListActivity> cls, @NonNull String channelUrl) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(url)) {
            ...
            Fragment fragment = createBannedListFragment(url);
    ...
    /**
     * It will be called when the BannedListActivity is being created.
     *
     * @return a new banned member list fragment
     * @since 1.2.0
     */
    protected Fragment createBannedListFragment(@NonNull String channelUrl) {
        return new BannedListFragment.Builder(channelUrl)
                .setUseHeader(true)
                .setUseHeaderRightButton(false)
                .setHeaderTitle(getString(R.string.sb_text_menu_banned_members))
                .setEmptyIcon(R.drawable.icon_ban, SendBirdUIKit.getDefaultThemeMode().getMonoTintColorStateList(this))
