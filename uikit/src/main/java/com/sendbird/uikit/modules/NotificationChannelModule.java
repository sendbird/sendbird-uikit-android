 ...
 * @since 3.5.0
 */
public class NotificationChannelModule extends BaseModule {
    @NonNull
    private final Params params;
    @NonNull
    private HeaderComponent headerComponent;
    @NonNull
    private NotificationMessageListComponent messageListComponent;
    @NonNull
     ...
     * @since 3.5.0
     */
    public NotificationChannelModule(@NonNull Context context) {
     ...
     * @since 3.5.0
     */
    public NotificationChannelModule(@NonNull Context context, @NonNull Params params) {
        this.params = params;
        this.headerComponent = new HeaderComponent();
        this.headerComponent.getParams().setUseLeftButton(false);
        this.messageListComponent = new NotificationMessageListComponent();
    ...
    public View onCreateView(@NonNull Context context, @NonNull LayoutInflater inflater, @Nullable Bundle args) {
        ...
        final View channelListLayout = this.messageListComponent.onCreateView(listThemeContext, listInflater, innerContainer, args);
    ...
    /**
     * Sets a custom notification channel header component.
     *
    ...
    /**
     * Sets a custom notification message list component.
     *
     * @param component The notification message list component to be used in this module
     * @since 3.5.0
     */
    public void setMessageListComponent(@NonNull NotificationMessageListComponent component) {
    ...
    /**
     * Returns the notification message list component.
     *
     * @return The notification message list component of this module
     * @since 3.5.0
     */
    @NonNull
    public NotificationMessageListComponent getMessageListComponent() {
    ...
    public static class Params extends BaseModule.Params {
        ...
        public Params(@NonNull Context context, @NonNull SendbirdUIKit.ThemeMode themeMode) {
            super(context, themeMode, R.attr.sb_module_notification_channel);
        }
        ...
        public Params(@NonNull Context context, @StyleRes int themeResId) {
            super(context, themeResId, R.attr.sb_module_notification_channel);
        }
    }
}
