...
public class OtherFileMessageView extends GroupChannelMessageView {
    private SbViewOtherFileMessageComponentBinding binding;
    ...
    public OtherFileMessageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.sb_message_file_style);
    }

    public OtherFileMessageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            this.binding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.sb_view_other_file_message_component, this, true);
            ...
            binding.contentPanelWithReactions.setBackground(DrawableUtils.setTintList(getContext(), messageBackground, messageBackgroundTint));
