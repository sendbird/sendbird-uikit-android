...
public class BannedListFragment extends UserTypeListFragment {
    ...
    private static class BannedMembersQueryHandler implements CustomMemberListQueryHandler<User> {
        private BannedUserListQuery query;
        private final GroupChannel channel;
        BannedMembersQueryHandler(@NonNull GroupChannel channel) {
            this.channel = channel;
        }

        @Override
        public void loadInitial(OnListResultHandler<User> handler) {
            this.query = channel.createBannedUserListQuery();
    ...
    public static class Builder {
        ...
        private BannedListFragment customFragment;
        ...
        /**
         * Sets the custom banned member list fragment. It must inherit {@link BannedListFragment}.
         * @param fragment custom banned member fragment.
         * @return This Builder object to allow for chaining of calls to set methods.
         *
         * @since 1.0.4
         */
        public <T extends BannedListFragment> Builder setCustomBannedMemberFragment(T fragment) {
        ...
        /**
         * Creates an {@link BannedListFragment} with the arguments supplied to this
         * builder.
         *
         * @return The {@link BannedListFragment} applied to the {@link Bundle}.
         */
        public BannedListFragment build() {
            BannedListFragment fragment = customFragment != null ? customFragment : new BannedListFragment();
